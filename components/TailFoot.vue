    ...
    <div class="max-w-screen-xl px-4 py-12 mx-auto sm:px-6 lg:py-16 lg:px-8">
        ...
        <div class="mt-8 xl:mt-0">
          ...
          <form class="mt-4 sm:flex sm:max-w-md">
            ...
            <div class="mt-3 rounded-md shadow sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button class="flex items-center justify-center w-full px-5 py-3 text-base font-medium leading-6 text-white transition duration-150 ease-in-out bg-blue-500 border border-transparent rounded-md hover:bg-blue-400 focus:outline-none focus:bg-blue-400">
                Subscribe
              </button>
            </div>
          </form>
      ...
      <div class="pt-8 mt-8 border-t border-gray-700 md:flex md:items-center md:justify-between">
        ...
        <p class="mt-8 text-base leading-6 text-gray-400 md:mt-0 md:order-1">
          &copy; 2020 Janitor Utah, Inc. All rights reserved.
        </p>
      </div>
    </div>
  </div>
