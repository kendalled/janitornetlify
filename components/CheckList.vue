...
-->
  <div class="bg-white">
    <div class="max-w-screen-xl px-4 py-16 mx-auto sm:px-6 lg:py-24 lg:px-8 lg:grid lg:grid-cols-3 lg:col-gap-8">
      <div>
        <h2 class="text-base font-semibold leading-6 tracking-wide text-blue-600 uppercase">
          Everything you need
        </h2>
      ...
      <div class="mt-12 lg:mt-0 lg:col-span-2">
        <dl class="space-y-10 sm:space-y-0 sm:grid sm:grid-cols-2 sm:grid-rows-4 sm:grid-flow-col sm:col-gap-6 sm:row-gap-10 lg:col-gap-8">
